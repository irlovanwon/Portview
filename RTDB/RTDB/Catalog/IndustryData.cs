...
namespace Irlovan.Database
{
    ...
    public class IndustryData<T> : Database, IIndustryData<T>
    {
        ...
        /// </summary>
        /// <param name="value"></param>
        public bool ReadValue(object value, QualityEnum quality = QualityEnum.Good) {
            T result;
            if (!ValueTypeFix(value, out result)) { return false; }
            ReadValue(result, quality);
            return true;
        }
        ...
        /// </summary>
        /// <param name="value"></param>
        public bool ReadValue(T value, QualityEnum quality = QualityEnum.Good) {
            lock (_lock) {
