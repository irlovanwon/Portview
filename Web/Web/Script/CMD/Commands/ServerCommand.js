...
Irlovan.CMD.ServerCommand = function (commandName,commandMessage, id) {
    this.Name = "ServerCMD";
...
Irlovan.CMD.ServerCommand.prototype.Init = function () {
...
Irlovan.CMD.ServerCommand.prototype.Action = function () {
    this.CMDHandler.Run(this.Command);
}

/**Dispose**/
Irlovan.CMD.ServerCommand.prototype.Dispose = function () {
