 ...
 */
		function euDock(){
		    ...
		    //**********modified on 2013-05-15 by irlovan 
       ...
       "<div id='" + this.id + "_bar' style='z-index:1000;position:absolute;border:0px solid black;'></div>", Irlovan.Global.BodyID, null);
			Irlovan.ControlHelper.CreateControlByStr(
       "<div onMouseOut='euEnv.euDockArray." + this.id + ".mouseOut();' onMouseOver='euEnv.euDockArray." + this.id + ".mouseOver();' id='" + this.id + "' style='z-index:1000;position:absolute;border:0px solid black; cursor: pointer;'></div>", Irlovan.Global.BodyID, null);
