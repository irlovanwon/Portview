...
Irlovan.EventAnalyser = function (id, containerID, gridContainerID, controlClass, config, left, top, zIndex, isLock) {
    Irlovan.Control.Classic.call(this, "EventAnalyser", id, containerID, gridContainerID, controlClass, config ? config : ({
        tagName: { Attributes: "tagName", Value: "EventAnalyser" },
...
Irlovan.EventAnalyser.prototype = new Irlovan.Control();
Irlovan.EventAnalyser.prototype.constructor = Irlovan.EventAnalyser;
//init div element
Irlovan.EventAnalyser.prototype.Init = function (id, containerID) {
...
Irlovan.EventAnalyser.prototype.DataPickerInit = function (id, focusID, onDatePickerSelect) {
...
Irlovan.EventAnalyser.prototype.PlotInit = function (titleName, data) {
...
Irlovan.EventAnalyser.prototype.UpdateTrend = function (doc) {
...
Irlovan.EventAnalyser.prototype.DataGridSelector = function () {
    if (!this.TrendGrid) {
...
Irlovan.EventAnalyser.prototype.Events = function () {
    //auto complete
...
Irlovan.EventAnalyser.prototype.GetAddVariable = function (name) {
...
Irlovan.EventAnalyser.prototype.SendRequest = function () {
...
Irlovan.EventAnalyser.prototype.RequestMessage = function (name) {
...
Irlovan.EventAnalyser.prototype.TrendDataInit = function (dataSubcriptionArray) {
    this.TrendData = [];
    for (var i = 0; i < dataSubcriptionArray.length; i++) {
        this.TrendData.push([]);
...
Irlovan.EventAnalyser.prototype.VariableSelectHandler = function (rowid, status, e) {
    //for bind extend
}
Irlovan.EventAnalyser.prototype.SetValue = function (name, colName, data) {
...
Irlovan.EventAnalyser.prototype.StartWebSocket = function (onSend) {
...
Irlovan.EventAnalyser.prototype.Dispose = function () {
    Irlovan.Control.Classic.prototype.Dispose.apply(this, []);
    this.SocketDispose();
}
Irlovan.EventAnalyser.prototype.SocketDispose = function () {
...
Irlovan.EventAnalyser.prototype.SetRecorderList = function () {
